             ...
             while ($row=mysqli_fetch_assoc($place_run))
              {
                ?>
                                    <tr>
                                        ...
                                        <?php echo "<td><a href='add-staff.php?up_id=" . $row['id'] . "'><button class='btn btn-primary'>Edit</button></a></td>"; ?>
                                      <?php  echo"<td ><a href='action/delete-staff.php?id=".$row['id']."'><button class='btn btn-primary'>Delete</button></a> </td>";?>
