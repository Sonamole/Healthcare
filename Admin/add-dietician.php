...
include('../Includes/config.php');
    ...
    $id=$_GET['up_id'];
    $sql="SELECT * from `dietician` WHERE `id`='$id'";
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add Dietician</h1>
      <nav>
      <a href="dietician-data.php"> <button class="btn btn-primary">View Dietician data</button></a>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Dietician</h5>

              <!-- Floating Labels Form -->
              <form class="row g-3" method="post" action="action/dieticianaction.php">
